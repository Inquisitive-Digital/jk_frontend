...
const stopModalScroll = (e) => {
  ...
  if (!atTop && !atBottom) {
    ...
    // If we're at the boundary, prevent default to stop the background from scrolling
    e.preventDefault();
  }
};
            ...
            <div className="w-full max-w-2xl">
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
                  <div className="p-6 space-y-4 flex-1 overflow-y-auto overscroll-contain" onWheel={stopModalScroll}>
                    {/* Name */}
                    <div>
